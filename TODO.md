...
## Done
- 2026-09-25: Commit decision for the green feat/boss-entity working tree — resolved: committed & merged to main (backend + frontend + docs in one interlocking unit), tagged v1.1-boss (34be5d1)
